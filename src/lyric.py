...
def insert_data(content, track_id,api):
    try:
        ...
        if api == "musix_match":
            query = f"INSERT INTO lyrics_temp (content, spotify_tracks_id, musix_match) VALUES ('{escaped_content}', '{track_id}', 'True')"
        elif api == "genius":
            query = f"INSERT INTO lyrics_temp (content, spotify_tracks_id, genius) VALUES ('{escaped_content}', '{track_id}', 'True')"
